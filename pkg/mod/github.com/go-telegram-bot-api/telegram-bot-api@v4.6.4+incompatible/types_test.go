...
func TestMessageTime(t *testing.T) {
	message := tgbotapi2.Message{Date: 0}
...
func TestMessageIsCommandWithCommand(t *testing.T) {
	message := tgbotapi2.Message{Text: "/command"}
	message.Entities = &[]tgbotapi2.MessageEntity{{Type: "bot_command", Offset: 0, Length: 8}}
...
func TestIsCommandWithText(t *testing.T) {
	message := tgbotapi2.Message{Text: "some text"}
...
func TestIsCommandWithEmptyText(t *testing.T) {
	message := tgbotapi2.Message{Text: ""}
...
func TestCommandWithNonCommand(t *testing.T) {
	message := tgbotapi2.Message{Text: "test text"}
...
func TestCommandWithBotName(t *testing.T) {
	message := tgbotapi2.Message{Text: "/command@testbot"}
	message.Entities = &[]tgbotapi2.MessageEntity{{Type: "bot_command", Offset: 0, Length: 16}}
...
func TestMessageCommandArgumentsWithArguments(t *testing.T) {
	message := tgbotapi2.Message{Text: "/command with arguments"}
	message.Entities = &[]tgbotapi2.MessageEntity{{Type: "bot_command", Offset: 0, Length: 8}}
...
func TestMessageCommandArgumentsWithMalformedArguments(t *testing.T) {
	message := tgbotapi2.Message{Text: "/command-without argument space"}
	message.Entities = &[]tgbotapi2.MessageEntity{{Type: "bot_command", Offset: 0, Length: 8}}
...
func TestMessageEntityParseURLGood(t *testing.T) {
	entity := tgbotapi2.MessageEntity{URL: "https://www.google.com"}
...
func TestMessageEntityParseURLBad(t *testing.T) {
	entity := tgbotapi2.MessageEntity{URL: ""}
...
func TestChatIsPrivate(t *testing.T) {
	chat := tgbotapi2.Chat{ID: 10, Type: "private"}
...
func TestChatIsGroup(t *testing.T) {
	chat := tgbotapi2.Chat{ID: 10, Type: "group"}
...
func TestChatIsChannel(t *testing.T) {
	chat := tgbotapi2.Chat{ID: 10, Type: "channel"}
...
func TestChatIsSuperGroup(t *testing.T) {
	chat := tgbotapi2.Chat{ID: 10, Type: "supergroup"}
...
func TestFileLink(t *testing.T) {
	file := tgbotapi2.File{FilePath: "test/test.txt"}
